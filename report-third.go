...
func reportThird() {
	plants := []PowerPlant{
		...
		PowerPlant{solar, 40, inactive}, // comma in the last line is not optional
	}
	load := 300.
	grid := PowerGrid{load, plants}
...
func requestOption() (option string) {
...
// no enums, use named strings instead
